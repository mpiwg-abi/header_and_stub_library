...
type(MPI_Datatype), parameter :: MPI_REAL2                      = MPI_Datatype(00000714)
...
type(MPI_Datatype), parameter :: MPI_COMPLEX4                   = MPI_Datatype(00000723)
...
! Predefined MPI_COMM_WORLD Attribute Keys
...
! Predefined Windows Attribute Keys
